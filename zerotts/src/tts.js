...
// Khoảng lặng 0,6 giây. Thông số khớp ĐÚNG clip giọng backend trả về, và khớp
// luôn Google TTS — engine chạy thông trên chính chiếc điện thoại bị lỗi:
// MPEG-2 Layer III, 24 kHz, mono, 64 kbps, luồng khung trần (byte đầu ff f3),
// không ID3, không Xing/Info, không khai báo độ trễ encoder.
//
// Vì sao 24 kHz: cùng app cùng chương, MuMuPlayer (decoder phần mềm trên PC)
// phát qua được, điện thoại thật thì dừng. Lỗi nằm ở decoder phần cứng của
// máy. Google trả 24 kHz và chạy được; ta trả 48 kHz và gãy.
//   ffmpeg -f lavfi -i anullsrc=r=24000:cl=mono -t 0.6 -c:a libmp3lame \n//     -b:a 64k -ar 24000 -write_xing 0 -id3v2_version 0 -map_metadata -1 out.mp3

...
// Khoảng lặng 0,6 giây, MP3 24 kHz mono 64 kbps, luồng khung trần — khớp đúng
// clip giọng backend trả về. Quay lại MP3 sau khi thử WAV: WAV không sửa được
// gì (lỗi nằm trong player của app, xem docs/playback-stall.md) mà payload
// nặng gấp ~6 lần, nên chọn bản nhẹ hơn.
